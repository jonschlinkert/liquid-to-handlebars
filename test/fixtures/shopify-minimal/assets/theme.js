...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      $thumbImages: $('#ProductThumbs', this.$container).find('a.product-single__thumbnail'),
    ...
    this.enableHistoryState = this.$container.data('enable-history-state') || false;
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
      ...
      if (!theme.variables.bpSmall) {
        ...
        this.selectors.$productImages.each(function() {
          $(this).bind('click', function() {
            ...
            $productImageGallery.filter('[data-image-id="' + imageId + '"]').trigger('click');
          });
        });
      }
    },
    ...
    initProductVariant: function() {
      ...
      if (product.options.length == 1 && product.options[0] != 'Title') {
        $('.selector-wrapper:eq(0)', this.$container).prepend('<label for="productSelect-option-0">' + product.options[0] + '</label>');
      }
    ...
    productImageZoom: function () {
      if (!theme.variables.bpSmall && this.zoomType == 'zoom-in'){
        if (!this.selectors.$productImages.length || this.selectors.$html.hasClass('supports-touch')) {
          return;
        };
...
function gm_authFailure() {
  if (Shopify.designMode) {
    ...
    theme.$currentMapContainer.find('.map-section__wrapper').html('<div class="errors text-center">' + theme.strings.authError + '</div>');
  }
}
